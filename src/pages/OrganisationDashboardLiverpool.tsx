...
export default function OrganisationDashboardLiverpool() {
  return (
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          <div className="p-4 bg-white rounded-2xl shadow-lg border">
            <OptimizedImage
              src="/lovable-uploads/aaeb603c-8140-467c-9571-cc97db7c5f56.png"
              alt="Liverpool FC logo"
              className="w-16 h-16 object-contain"
            />
          </div>
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-gradient">Liverpool FC Dashboard</h1>
      ...
      <Card className="bg-gradient-to-br from-primary/10 via-primary/5 to-accent/10 border border-primary/20">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            The Liverpool FC organisation dashboard is currently being configured. 
