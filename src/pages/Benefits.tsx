    ...
    <Card className="card-professional overflow-hidden h-full flex flex-col">
      ...
      <CardContent className="pt-0 mt-auto">
        <Button 
          ...
          variant="outline" 
          className="-mx-6 flex items-center justify-center gap-2 px-8 py-4 h-auto hover-scale hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all duration-200"
        >
